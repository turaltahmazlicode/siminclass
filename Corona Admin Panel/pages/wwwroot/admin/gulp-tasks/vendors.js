...
gulp.task('buildOptionalVendorScripts', function() {
    ...
    var aScript6 = gulp.src(['node_modules/jvectormap/tests/~/admin/assets/jquery-jvectormap-world-mill-en.js'])
        .pipe(gulp.dest('./~/admin/assets/vendors/jvectormap'));
    var aScript7 = gulp.src(['node_modules/jvectormap/tests/~/admin/assets/jquery-jvectormap-world-mill-en.js'])
        .pipe(gulp.dest('./~/admin/assets/vendors/jvectormap'));
    ...
    var aScript11 = gulp.src(['node_modules/codemirror/mode/shell/shell.js'])
        .pipe(gulp.dest('./~/admin/assets/vendors/codemirror'));
    var aScript12 = gulp.src(['node_modules/pwstabs/~/admin/assets/jquery.pwstabs.min.js'])
...
gulp.task('buildOptionalVendorStyles', function() {
    ...
    var aStyle7 = gulp.src(['node_modules/jvectormap/jquery-jvectormap.css'])
        .pipe(gulp.dest('./~/admin/assets/vendors/jvectormap')); 
    var aStyle8 = gulp.src(['node_modules/owl.carousel/dist/~/admin/assets/owl.carousel.min.css'])
        .pipe(gulp.dest('./~/admin/assets/vendors/owl-carousel-2'));
    var aStyle9 = gulp.src(['node_modules/owl.carousel/dist/~/admin/assets/owl.theme.default.min.css'])
        .pipe(gulp.dest('./~/admin/assets/vendors/owl-carousel-2'));
    var aStyle10 = gulp.src(['node_modules/owl.carousel/dist/~/admin/assets/owl.video.play.png'])
        .pipe(gulp.dest('./~/admin/assets/vendors/owl-carousel-2'));
    ...
    var aStyle12 = gulp.src(['node_modules/codemirror/theme/ambiance.css'])
        .pipe(gulp.dest('./~/admin/assets/vendors/codemirror'));
    var aStyle13 = gulp.src(['node_modules/pwstabs/~/admin/assets/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./~/admin/assets/vendors/pwstabs'));
